    ...
    <footer className="bg-secondary text-primary py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Mal&apos;s Mandi</h3>
            <p className="text-gray-400">
              Your one-stop shop for unique, handcrafted products. Browse our collection and reach out via WhatsApp for enquiries.
            </p>
          </div>
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-accent text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity"
            >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Mal&apos;s Mandi. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
