        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 flex-shrink-0">
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <Link href="/#categories" className="text-secondary hover:text-accent transition-colors">
                Categories
              </Link>
              <Link href="/#products" className="text-secondary hover:text-accent transition-colors">
                Products
              </Link>
            </nav>
